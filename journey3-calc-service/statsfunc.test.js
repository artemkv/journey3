...
test('getDaysSince', () => {
  ...
  expect(statsfunc.getDaysSince('2022-03-23T23:25:28.924017Z', '2022-03-24T17:30:50.888718Z')).toBe(0);
  ...
  expect(statsfunc.getDaysSince('2022-03-23T17:30:50.888718Z', '2022-03-24T17:30:49.888718Z')).toBe(0);
